...
* **Status (as of Dec 26, 2025):** 3.0.7 is EOL
...
* **Follow-up:** [3.4](3.4.html#warning-to-prepare-for-freezing-string-literals-in-ruby-35): `Symbol#to_s` produces "chilled" string (it is not frozen, but emits deprecation warning on attempt to modify), and will probably become frozen in 3.5.
...
* **Follow-up:s**
  * [3.1](3.1.html#fiber-scheduler-new-hooks): more scheduler hooks were added to make more core methods support asynchronous execution;
  * [3.2](3.2.html#fiberschedulerio_select) even more hooks were added, and `SchedulerInteface` documentation abstraction was renamed to `Scheduler`.
  * [3.4](3.4.html#fiberschedulerblocking_operation_wait): `#blocking_operation_wait` hook is added
  * [4.0](4.0.html#fiberscheduler): several more hooks added
