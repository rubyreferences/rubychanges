...
* `Set`: as parts of ongoing "Sets: need ♥️" initiative ([Feature #16989](https://bugs.ruby-lang.org/issues/16989)), some adjustments were maid:
  ...
  * [Set#join](https://docs.ruby-lang.org/en/master/Set.html#method-i-join) is added as a shorthand for `.to_a.join`. Discussion: [Feature #16991](https://bugs.ruby-lang.org/issues/16991).
  * [Set#<=>](https://docs.ruby-lang.org/en/master/Set.html#method-i-3C-3D-3E): returns `-1`/`+1` if one set is the proper sub-/super-set of the other, `0` if they are equal, and `nil` otherwise:
    ```ruby
    Set[1, 2, 3] <=> Set[2, 3] # => 1
...
* `open-uri`: redefinition of `Kernel#open`, [deprecated in 2.7](2.7.html#network-and-web) in favor of `URI.open`, is removed. Discussion: [Misc #15893](https://bugs.ruby-lang.org/issues/15893).
