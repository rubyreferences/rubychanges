...
* **Documentation:** [doc/syntax/pattern_matching.rdoc](https://docs.ruby-lang.org/en/master/doc/syntax/pattern_matching_rdoc.html)
* **Code:**
  ```ruby
  # match and unpack:
...
> For deeper understanding, please check those tools' documentation; also [this article](https://evilmartians.com/chronicles/climbing-steep-hills-or-adopting-ruby-types) by Vladimir Dementiev of Evil Martians takes a detailed look into tools and concepts.
...
* **Documentation:** [Kernel#clone](https://docs.ruby-lang.org/en/master/Kernel.html#method-i-clone)
* **Code:**
  ```ruby
  o = Object.new
...
* **Affected methods:** [Kernel#eval](https://docs.ruby-lang.org/en/master/Kernel.html#method-i-eval), [Binding#eval](https://docs.ruby-lang.org/en/master/Binding.html#method-i-eval)
* **Code:**
  ```ruby
  # file a.rb
  class A
...
* **Documentation:**
  * [Module#private](https://docs.ruby-lang.org/en/master/Module.html#method-i-private), [Module#public](https://docs.ruby-lang.org/en/master/Module.html#method-i-public), [Module#protected](https://docs.ruby-lang.org/en/master/Module.html#method-i-protected) are accepting arrays;
  ...
  * [Module#alias_method](https://docs.ruby-lang.org/en/master/Module.html#method-i-alias_method) returns the name of created method;
...
* **Documentation:** [Warning#warn](https://docs.ruby-lang.org/en/master/Warning.html#method-i-warn), [Kernel#warn](https://docs.ruby-lang.org/en/master/Kernel.html#method-i-warn)
* **Code:**
  ```ruby
...
* **Documentation:** [Symbol#name](https://docs.ruby-lang.org/en/master/Symbol.html#method-i-name)
...
* **Documentation:** [Array#[]](https://docs.ruby-lang.org/en/master/Array.html#method-i-5B-5D)
* **Code:**
  ```ruby
...
* **Documentation:** [Hash#except](https://docs.ruby-lang.org/en/master/Hash.html#method-i-except), [ENV.except](https://docs.ruby-lang.org/en/master/ENV.html#method-c-except)
* **Code:**
  ```ruby
  h = {a: 1, b: 2}
  h.except(:b)
...
* **Documentation:** [Hash#transform_keys](https://docs.ruby-lang.org/en/master/Hash.html#method-i-transform_keys)
* **Code:**
  ```ruby
...
* **Reason:** Lazy Proc allocation optimization (not creating `Proc` object while just propagating `&block` further) introduced an inconvenience for some DSL libraries, when what are "logically" two references to the same proc, would became two unrelated object, which might lead to subtle bugs.
* **Discussion:** [Feature #14267](https://bugs.ruby-lang.org/issues/14267)
* **Documentation:** [Proc#==](https://docs.ruby-lang.org/en/master/Proc.html#method-i-3D-3D)
* **Code:**
  ```ruby
  class SomeDSL
...
* **Reason:** With the introduction of the [Ractors](#ractors), a global mutable objects can't be used, and `Random::DEFAULT` was such object (its state have changed with each `#rand` call); so now the default random generator is ractor-local, and is not exposed as a constant (it is decided that it would be too confusing to have a constant with the value different in each ractor).
...
* **Documentation:** [Random](https://docs.ruby-lang.org/en/master/Random.html)
* **Code:**
  ```ruby
  Warning[:deprecated] = true
  Random::DEFAULT
  ...
  ```
* **Notes:**
  * See [Ractors](#ractors) explanation below, and [Ractor](https://docs.ruby-lang.org/en/master/Ractor.html) class docs for deeper understanding of ractors data sharing model.
...
* **Documentation:** [Dir.glob](https://docs.ruby-lang.org/en/master/Dir.html#method-c-glob)
...
For a deeper dive into Ractors, see [Ractor](https://docs.ruby-lang.org/en/master/Ractor.html) class documentation, and [Ractor design document](https://docs.ruby-lang.org/en/master/doc/ractor_md.html).
...
* **Documentation:** [doc/fiber.md](https://docs.ruby-lang.org/en/master/doc/fiber_md.html)
* **Code:**
  ```ruby
  require 'net/http'
...
* **Documentation:** [Thread.ignore_deadlock=](https://docs.ruby-lang.org/en/master/Thread.html#method-c-ignore_deadlock-3D), [Thread.ignore_deadlock](https://docs.ruby-lang.org/en/master/Thread.html#method-c-ignore_deadlock)
* **Code:**
  ```ruby
  queue1 = Queue.new
  queue2 = Queue.new
...
* **Documentation:** [Fiber#backtrace](https://docs.ruby-lang.org/en/master/Fiber.html#method-i-backtrace), [Fiber#backtrace_locations](https://docs.ruby-lang.org/en/master/Fiber.html#method-i-backtrace_locations),
* **Code:**
  ```ruby
...
The method that allows fiber to pass control to other fiber directly, allowing several fibers to control each other. Before 3.0, this method's rule was: once the fiber was `transfer`red to, it can't be `resume`d. This limitation is lifted, and instead there are now a new set of more granular limitations:

* **Reason:**
* **Discussion:** [Bug #17221](https://bugs.ruby-lang.org/issues/17221)
* **Documentation:** [Fiber#transfer](https://docs.ruby-lang.org/en/master/Fiber.html#method-i-transfer)
* **Code:**
* **Notes:** The full list of the new limitations are:
  * Can't `transfer` to the fiber resumed (e.g. at least one received control via `resume`, and not `transfer`)
  * Can't `transfer` to the fiber yielding (e.g. the one that run `Fiber.yield` waiting to be `resume`d)
...
* **Documentation:** [GC.auto_compact](https://docs.ruby-lang.org/en/master/GC.html#method-c-auto_compact), [GC.auto_compact=](https://docs.ruby-lang.org/en/master/GC.html#method-c-auto_compact-3D)
...
* `Net::HTTP`
  * [Net::HTTP#verify_hostname](https://docs.ruby-lang.org/en/master/Net/HTTP.html#attribute-i-verify_hostname) accessor allows to skip hostname verification.  Discussion: [Feature #16555](https://bugs.ruby-lang.org/issues/16555).
...
* `Socket`
    * Add `:connect_timeout` keyword argument to [TCPSocket.new](https://docs.ruby-lang.org/en/master/TCPSocket.html#method-c-new). Discussion: [Feature #17187](https://bugs.ruby-lang.org/issues/17187)
