...
* **Documentation:** [Calling Methods: Unpacking Positional Arguments](https://docs.ruby-lang.org/en/master/syntax/calling_methods_rdoc.html#label-Unpacking+Positional+Arguments)
...
* Process creation by `Kernel#open` and `IO` with leading `|` is removed. Discussion: [Feature #19630](https://bugs.ruby-lang.org/issues/19630)
...
* **Documentation:** [Ruby](https://docs.ruby-lang.org/en/master/Ruby.html)
* **Code:**
  ```ruby
  Ruby.constants
...
* **Documentation:** [Object#inspect](https://docs.ruby-lang.org/en/master/Object.html#method-i-inspect)
* **Code:**
  ```ruby
  class User
...
* **Documentation:** [Math.log1p](https://docs.ruby-lang.org/en/master/Math.html#method-c-log1p), [Math.expm1](https://docs.ruby-lang.org/en/master/Math.html#method-c-expm1)
* **Code:**
  ```ruby
  1 + 1e-16
...
* **Documentation:** [Range#to_set](https://docs.ruby-lang.org/en/master/Range.html#method-i-to_set)
* **Code:**
  ```ruby
  (1..).to_set
...
* **Documentation:** [Range#overlap?](https://docs.ruby-lang.org/en/master/Range.html#method-i-overlap-3F) (no special mention of fully-infinite ranges though)
* **Code:**
  ```ruby
...
* **Documentation:** [Range#max](https://docs.ruby-lang.org/en/master/Range.html#method-i-max)
* **Code:**
  ```ruby
...
* **Documentation:** [Array#find](https://docs.ruby-lang.org/en/master/Array.html#method-i-find), [Array#rfind](https://docs.ruby-lang.org/en/master/Array.html#method-i-rfind)
* **Code:**
  ```ruby
  ...
  # prints: {args: []}
  ```
  (The behavior of `Array#find` is not demonstrated, as it is exactly the same as [Enumerable#find](https://docs.ruby-lang.org/en/master/Enumerable.html#method-i-find).)
...
* **Documentation:** [Set](https://docs.ruby-lang.org/en/master/Set.html)
...
* **Discussion:** [Set#inspect](https://docs.ruby-lang.org/en/master/Set.html#method-i-inspect)
* **Documentation:** [Feature #21389](https://bugs.ruby-lang.org/issues/21389)
* **Code:**
  ```ruby
  p Set[1, 2, 3]
  # Ruby 3.4: #<Set: {1, 2, 3}>
...
* **Documentation:** [Set#to_set](https://docs.ruby-lang.org/en/master/Set.html#method-i-to_set), [Enumerable#to_set](https://docs.ruby-lang.org/en/master/Enumerable.html#method-i-to_set).
* **Code:**
  ```ruby
...
* **Documentation:** [Proc#parameters](https://docs.ruby-lang.org/en/master/Proc.html#method-i-parameters)
* **Code:**
  ```ruby
  -> { it + 1 }.parameters
...
The argument allows to provide the meta-information about the number of iterations, if it is known beforehand, like [Enumerator.new](https://docs.ruby-lang.org/en/master/Enumerator.html#method-c-new) allows.

* **Discussion:** [Feature #21701](https://bugs.ruby-lang.org/issues/21701)
* **Documentation:** [Enumerator.produce](https://docs.ruby-lang.org/en/master/Enumerator.html#method-c-produce)
* **Code:**
  ```ruby
...
* **Notes:**
  * Several methods aren't in the core class, as they depend on additional libraries: [#rmtree](https://docs.ruby-lang.org/en/master/Pathname.html#method-i-rmtree) and [.mktmpdir](https://docs.ruby-lang.org/en/master/Pathname.html#method-c-mktmpdir) depend on [fileutils](https://docs.ruby-lang.org/en/master/FileUtils.html) standard library, while [#find](https://docs.ruby-lang.org/en/master/Pathname.html#method-i-find) depends on [find](https://docs.ruby-lang.org/en/master/Find.html) standard library. To access them, your code needs to explicitly `require 'pathname'` which requires a small standard library file that now defines just those three methods (the same way as `require 'time'` makes [Time.parse](https://docs.ruby-lang.org/en/master/Time.html#method-c-parse) available). When the methods are called, the necessary additional libraries are required:
    ...
    ```
  * Another method, [#mkpath](https://docs.ruby-lang.org/en/master/Pathname.html#method-i-mkpath), that have previously depended on `fileutils`, is reimplemented in the core `Pathname` itself. It might be that the rest of them will be reimplemented, too.
...
* **Documentation:** [Ruby::Box](https://docs.ruby-lang.org/en/master/Ruby/Box.html)
...
* **Documentation:** [ArgumentError](https://docs.ruby-lang.org/en/master/ArgumentError.html) (doesn't show the backtrace anyway)
...
* **Documentation:** [Thread#raise](https://docs.ruby-lang.org/en/master/Thread.html#method-i-raise), [Fiber#raise](https://docs.ruby-lang.org/en/master/Fiber.html#method-i-raise)
* **Code:**
  ```ruby
  f = Fiber.new do
    Fiber.yield 1
...
* **Documentation:** [IO.select](https://docs.ruby-lang.org/en/master/IO.html#method-c-select)
* **Code:**
* **Notes:**
...
* **Documentation:** [Socket.tcp](https://docs.ruby-lang.org/en/master/Socket.html#method-c-tcp), [TCPSocket.new](https://docs.ruby-lang.org/en/master/TCPSocket.html#method-c-new)
* **Code:**
* **Notes:**
...
* **Discussion:** —
* **Documentation:** [Ractor.select](https://docs.ruby-lang.org/en/master/Ractor.html#method-c-select)
* **Code:**
  ```ruby
  port = Ractor::Port.new
...
* **Documentation:** [Ractor.shareable_proc](https://docs.ruby-lang.org/en/master/Ractor.html#method-c-shareable_proc), [Ractor.shareable_lambda](https://docs.ruby-lang.org/en/master/Ractor.html#method-c-shareable_lambda)
* **Code:**
  ```ruby
  p = proc { puts "test" }
...
* **Documentation:** [Fiber::Scheduler#fiber_interrupt](https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-fiber_interrupt)
* **Code:**
  ```ruby
...
* **Documentation:** [Fiber::Scheduler#yield](https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-yield)
* **Code:**
* **Notes:**
...
* **Reason:**
* **Discussion:**
* **Documentation:** [Fiber::Scheduler#io_close](https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-io_close)
* **Code:**
* **Notes:**
...
* **Documentation:** [Fiber::Scheduler#io_write](https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-io_write)
* **Code:**
* **Notes:**
