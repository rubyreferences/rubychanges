...
* **Status (as of <<date>>):** 3.3.10 is current _stable_
...
* **Follow-up:** [3.4](3.4.html#standalone-it-in-blocks-became-anonymous-argument): `it` was successfully introduced.
...
* **Documentation:** [Kernel#lambda](https://docs.ruby-lang.org/en/3.3/Kernel.html#method-i-lambda) _(no specific details are provided, though)_
* **Code:**
  ```ruby
  # Intended usage:
  l = lambda { |a, b| a + b }
...
* **Documentation:** — (Adheres to the behavior described for [Object#dup](https://docs.ruby-lang.org/en/3.3/Object.html#method-i-dup) and [#clone](https://docs.ruby-lang.org/en/3.3/Kernel.html#method-i-clone))
* **Code:**
  ```ruby
...
* **Documentation:** [Module#set_temporary_name](https://docs.ruby-lang.org/en/3.3/Module.html#method-i-set_temporary_name)
* **Code:**
  ```ruby
...
* **Documentation:** [Refinement#target](https://docs.ruby-lang.org/en/3.3/Refinement.html#method-i-target)
* **Follow-up:** [3.4](3.4.html#removals): The method is removed.
...
* **Documentation:** [String#bytesplice](https://docs.ruby-lang.org/en/3.3/String.html#method-i-bytesplice)
* **Code:**
  ```ruby
  # Base usage
  buf1 = "Слава Україні!"
...
* **Documentation:** [MatchData#named_captures](https://docs.ruby-lang.org/en/3.3/MatchData.html#method-i-named_captures)
* **Code:**
  ```ruby
...
* **Documentation:** [Time#new](https://docs.ruby-lang.org/en/3.3/Time.html#method-c-new)
* **Code:**
  ```ruby
  Time.new('2023-12-20')
...
* **Documentation:** [doc/packed_data.rdoc](https://docs.ruby-lang.org/en/3.3/packed_data_rdoc.html)
* **Code:**
  ```ruby
  [1, 2, 3].pack('r*')
  # Ruby 3.1:
...
* **Documentation:** [Set#merge](https://docs.ruby-lang.org/en/3.3/Set.html#method-i-merge)
* **Code:**
  ```ruby
...
* **Documentation:** [ObjectSpace::WeakKeyMap](https://docs.ruby-lang.org/en/3.3/ObjectSpace/WeakKeyMap.html)
* **Code:**
  ```ruby
...
* **Documentation:** [Thread::Queue#freeze](https://docs.ruby-lang.org/en/3.3/Thread/Queue.html#method-i-freeze) and [Thread::SizedQueue#freeze](https://docs.ruby-lang.org/en/3.3/Thread/SizedQueue.html#method-i-freeze)
...
* **Documentation:** [Range#reverse_each](https://docs.ruby-lang.org/en/3.3/Range.html#method-i-reverse_each)
* **Code:**
  ```ruby
...
* **Documentation:** [Range#overlap?](https://docs.ruby-lang.org/en/3.3/Range.html#method-i-overlap-3F)
* **Code:**
  ```ruby
...
* **Documentation:** [Dir.for_fd](https://docs.ruby-lang.org/en/3.3/Dir.html#method-c-for_fd), [Dir.fchdir](https://docs.ruby-lang.org/en/3.3/Dir.html#method-c-fchdir)
* **Code:**
  ```ruby
...
An instance method version of [Dir.chdir](https://docs.ruby-lang.org/en/3.3/Dir.html#method-c-chdir): changes the current working directory to one specified by the `Dir` instance.

* **Discussion:** [Feature #19347](https://bugs.ruby-lang.org/issues/19347)
* **Documentation:** [Dir#chdir](https://docs.ruby-lang.org/en/3.3/Dir.html#method-i-chdir)
* **Code:**
  ```ruby
...
* **Affected methods:**
  * [Kernel#open](https://docs.ruby-lang.org/en/3.3/Kernel.html#method-i-open)
  * [IO.binread](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-binread)
  * [IO.foreach](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-foreach)
  * [IO.readlines](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-readlines)
  * [IO.read](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-read)
  * [IO.write](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-write)
  * [URI.open](https://docs.ruby-lang.org/en/3.3/URI.html#method-c-open) ([open-uri](https://github.com/ruby/open-uri) standard library)
* **Code:**
  ```ruby
  IO.read('| ls')
...
* **Notes:**
  ...
  * As advised by the warning, [IO.popen](https://docs.ruby-lang.org/en/3.3/IO.html#method-c-popen) is a specialized method when communicating with an external process is desired functionality:
    ```ruby
    IO.popen('ls')
    #=> contents of the current folder
    ```
...
* **Follow-up:** Fully removed [in 4.0](4.0.html#removals), which turned out to be just two versions later!
...
* **Documentation:** [NoMethodError](https://docs.ruby-lang.org/en/3.3/NoMethodError.html)
* **Code:**
  ```ruby
  "hello".to_ary
...
* **Documentation:** [Fiber#kill](https://docs.ruby-lang.org/en/3.3/Fiber.html#method-i-kill)
* **Code:**
  ```ruby
  f = Fiber.new do
...
* **Documentation:** [Warning#[category]](https://docs.ruby-lang.org/en/3.3/Warning.html#method-c-5B-5D)
...
* **Documentation:** [Process.warmup](https://docs.ruby-lang.org/en/3.3/Process.html#method-c-warmup)
...
* **Documentation:** [Process::Status#&](https://docs.ruby-lang.org/en/3.3/Process/Status.html#method-i-26), [#>>](https://docs.ruby-lang.org/en/3.3/Process/Status.html#method-i-3E-3E)
* **Follow-up:** Removed [in 4.0](4.0.html#removals).
...
* **Documentation:** [TracePoint#Events](https://docs.ruby-lang.org/en/3.3/TracePoint.html#class-TracePoint-label-Events)
* **Code:**
  ```ruby
  ...
  ```
* **Notes:** The event-specific attribute for the event is the same as for `:raise`: [#raised_exception](https://docs.ruby-lang.org/en/3.3/TracePoint.html#method-i-raised_exception).
...
* [Random::Formatter#alphanumeric](https://docs.ruby-lang.org/en/3.3/Random/Formatter.html#method-i-alphanumeric): `chars` keyword argument. [Feature #18183](https://bugs.ruby-lang.org/issues/18183):
  ```ruby
...
* **[prism](https://github.com/ruby/prism) (nee YARP) is added.** It is a new Ruby code parser, developed by Kevin Newton, which intends to become _the_ Ruby parser, shared by all implementations (not only CRuby/MRI, but also TruffleRuby, JRuby, and others) and tools that need to parser Ruby code (like Sorbet or Rubocop). It doesn't replace CRuby's Ruby parser, at least for now, but can be used to parse Ruby quickly and produce robust, easy to use AST.
  * **Documentation:** [Prism](https://docs.ruby-lang.org/en/3.3/Prism.html) (it isn't very well rendered in the standard library docs, so the [official site](https://ruby.github.io/prism/) is recommended);
