...
* [3.2](3.2.md#removals) Language changes: Removals (—)
* [3.4](3.4.md#keyword-and-block-arguments-are-prohibited-in-) Language changes: Keyword and block arguments are prohibited in `#[]=` (—)
* [3.4](3.4.md#warnings-about-unused-blocks) Language changes: Warnings about unused blocks (—)
...
<!--
* [3.2](3.2.md#constant-assignment-evaluation-order-changed) Language changes: Constant assignment evaluation order changed (—)
...
<!--
* [3.2](3.2.md#matchdata-added-deconstruct-and-deconstruct_keys) Core classes and modules: Pattern matching: `MatchData`: added `#deconstruct` and `#deconstruct_keys` ([MatchData#deconstruct](https://docs.ruby-lang.org/en/3.2/MatchData.html#method-i-deconstruct), [MatchData#deconstruct_keys](https://docs.ruby-lang.org/en/3.2/MatchData.html#method-i-deconstruct_keys))
* [3.2](3.2.md#timedeconstruct_keys) Core classes and modules: Pattern matching: `Time#deconstruct_keys` ([Time#deconstruct_keys](https://docs.ruby-lang.org/en/3.2/Time.html#method-i-deconstruct_keys))
...
* [3.2](3.2.md#hashshift-always-returns-nil-if-the-hash-is-empty) `Hash#shift` always returns `nil` if the hash is empty ([Hash#shift](https://docs.ruby-lang.org/en/3.2/Hash.html#method-i-shift))
-->
...
* **2.1** **[Exception#backtrace_locations](https://docs.ruby-lang.org/en/2.1.0/Exception.html#method-i-backtrace_locations)**
...
* [3.4](3.4.md#warning-to-prepare-for-freezing-string-literals-in-ruby-35) Warning to prepare for freezing string literals in Ruby 3.5
