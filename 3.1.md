...
* **Status (as of Jan 05, 2022):** 3.1.0 is current _stable_
...
* new gem <a class="github" href="https://github.com/ruby/error_highlight">errors_highlight</a> was introduced and is enabled by default, allowing more fine-grained error messages:
  ```ruby
  data = {body: {items: []}}
