...
* **Status (as of Dec 25, 2024):** 3.4.1 is recently released (immediately after 3.4.0)
* **This document first published:** Dec 25, 2023
* **Last change to this document:** Dec 25, 2024
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Proc.html#class-Proc-label-it">Proc: `it`</a>
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/syntax/calling_methods_rdoc.html#label-Unpacking+Keyword+Arguments">Calling Methods: Unpacking Keyword Arguments</a>
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Object.html#method-i-singleton_method"><code>Object#singleton_method</code></a>
* **Code:**
* **Notes:**
  ```ruby
  module Extensions
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Kernel.html#method-i-Float"><code>Kernel#Float</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/String.html#method-i-to_f"><code>String#to_f</code></a>
* **Code:**
  ```ruby
  Float('1.')
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/String.html#method-i-append_as_bytes"><code>String#append_as_bytes</code></a>
* **Code:**
  ```ruby
  buf = "msg@>".b
  content = "Україна"
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/MatchData.html#method-i-bytebegin"><code>MatchData#bytebegin</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/MatchData.html#method-i-byteend"><code>MatchData#byteend</code></a>
* **Code:**
  ```ruby
  str = 'Слава Україні'
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Time.html#method-i-xmlschema"><code>Time#xmlschema</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Time.html#method-i-iso8601"><code>Time#iso8601</code></a>
* **Code:**
  ```ruby
  ...
  ```
* **Notes:**
  * Unfortunately <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Time.html#method-i-xmlschema">the documentation</a> still refers to `time` standard library, even though the method is now defined in C; this is just a documentation rendering problem.
  * <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Time.html#method-c-xmlschema"><code>Time.xmlschema</code></a> (symmetrical parsing method) is confusingly still defined in `time` standard library, in Ruby.
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Range.html#method-i-size"><code>Range#size</code></a>
* **Code:**
  ```ruby
  (1..5).size
  # 3.3 & 3.4: => 5
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Range.html#method-i-step"><code>Range#step</code></a>
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Array.html#method-i-fetch_values"><code>Array#fetch_values</code></a>
* **Code:**
  ```ruby
  ary = %w[a b c]
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Hash.html#method-c-new"><code>Hash.new</code></a>
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Hash.html#method-i-inspect"><code>Hash#inspect</code></a>
* **Code:**
  ```ruby
...
Returns the list of all warning categories that can be set by <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Warning.html#method-c-5B-5D-3D"><code>Warning[]=</code></a> or running Ruby with `-W:<category name>`.

* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/20293">Feature #20293</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Warning.html#method-c-categories"><code>Warning.categories</code></a>
* **Code:**
  ```ruby
  Warning.categories
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/GC.html#method-c-config"><code>GC.config</code></a>
* **Code:**
  ```ruby
  GC.config
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-blocking_operation_wait"><code>Fiber::Scheduler#blocking_operation_wait</code></a>
* **Notes:**
...
* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/20876">Feature #20876</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-main-3F"><code>Ractor.main?</code></a>
* **Code:**
  ```ruby
...
A pair of methods provides a Ractor-local storage, akin to <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber.html#method-c-5B-5D"><code>Fiber.[]</code></a> and <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber.html#method-c-5B-5D-3D"><code>.[]=</code></a>.

* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/20715">Feature #20715</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-5B-5D"><code>Ractor.[]</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-5B-5D-3D"><code>Ractor.[]=</code></a>
* **Code:**
  ```ruby
  p Ractor[:value] #=> nil
  Ractor[:value] = 10
  ...
  ```
* **Notes:** Like Fiber's methods, and unlike <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Thread.html#method-i-5B-5D"><code>Thread#[]</code></a> and <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Thread.html#method-i-5B-5D-3D"><code>#[]=</code></a>, you only can access to the current Ractor's storage.
...
* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/20702">Feature #20702</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-store_if_absent"><code>Ractor.store_if_absent</code></a>
* **Code:**
  ```ruby
  def calculate
...
* <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Socket/ResolutionError.html"><code>Socket::ResolutionError</code></a> is added and raised on unsuccessful name resolution instead of generic `SocketError`. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/20018">Feature #20018</a>.
* <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Timeout.html#method-c-timeout"><code>Timeout.timeout</code></a> fails on negative values. Discussion: <a class="tracker bug" href="https://bugs.ruby-lang.org/issues/20795">Bug #20795</a>
