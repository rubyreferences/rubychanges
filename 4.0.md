...
* **Status (as of Dec 25, 2025):** 4.0 is just released
* **This document first published:** Dec 25, 2025
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/syntax/calling_methods_rdoc.html#label-Unpacking+Positional+Arguments">Calling Methods: Unpacking Positional Arguments</a>
...
* Process creation by `Kernel#open` and `IO` with leading `|` is removed. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/19630">Feature #19630</a>
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ruby.html"><code>Ruby</code></a>
* **Code:**
  ```ruby
  Ruby.constants
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Object.html#method-i-inspect"><code>Object#inspect</code></a>
* **Code:**
  ```ruby
  class User
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Math.html#method-c-log1p"><code>Math.log1p</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Math.html#method-c-expm1"><code>Math.expm1</code></a>
* **Code:**
  ```ruby
  1 + 1e-16
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Range.html#method-i-to_set"><code>Range#to_set</code></a>
* **Code:**
  ```ruby
  (1..).to_set
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Range.html#method-i-overlap-3F"><code>Range#overlap?</code></a> (no special mention of fully-infinite ranges though)
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Range.html#method-i-max"><code>Range#max</code></a>
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Array.html#method-i-find"><code>Array#find</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Array.html#method-i-rfind"><code>Array#rfind</code></a>
* **Code:**
  ```ruby
  ...
  # prints: {args: []}
  ```
  (The behavior of `Array#find` is not demonstrated, as it is exactly the same as <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Enumerable.html#method-i-find"><code>Enumerable#find</code></a>.)
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Set.html"><code>Set</code></a>
...
* **Discussion:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Set.html#method-i-inspect"><code>Set#inspect</code></a>
* **Documentation:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/21389">Feature #21389</a>
* **Code:**
  ```ruby
  p Set[1, 2, 3]
  # Ruby 3.4: #<Set: {1, 2, 3}>
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Set.html#method-i-to_set"><code>Set#to_set</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Enumerable.html#method-i-to_set"><code>Enumerable#to_set</code></a>.
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Proc.html#method-i-parameters"><code>Proc#parameters</code></a>
* **Code:**
  ```ruby
  -> { it + 1 }.parameters
...
The argument allows to provide the meta-information about the number of iterations, if it is known beforehand, like <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Enumerator.html#method-c-new"><code>Enumerator.new</code></a> allows.

* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/21701">Feature #21701</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Enumerator.html#method-c-produce"><code>Enumerator.produce</code></a>
* **Code:**
  ```ruby
...
* **Notes:**
  * Several methods aren't in the core class, as they depend on additional libraries: <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Pathname.html#method-i-rmtree"><code>#rmtree</code></a> and <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Pathname.html#method-c-mktmpdir"><code>.mktmpdir</code></a> depend on <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/FileUtils.html"><code>fileutils</code></a> standard library, while <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Pathname.html#method-i-find"><code>#find</code></a> depends on <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Find.html"><code>find</code></a> standard library. To access them, your code needs to explicitly `require 'pathname'` which requires a small standard library file that now defines just those three methods (the same way as `require 'time'` makes <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Time.html#method-c-parse"><code>Time.parse</code></a> available). When the methods are called, the necessary additional libraries are required:
    ...
    ```
  * Another method, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Pathname.html#method-i-mkpath"><code>#mkpath</code></a>, that have previously depended on `fileutils`, is reimplemented in the core `Pathname` itself. It might be that the rest of them will be reimplemented, too.
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ruby/Box.html"><code>Ruby::Box</code></a>
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/ArgumentError.html"><code>ArgumentError</code></a> (doesn't show the backtrace anyway)
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Thread.html#method-i-raise"><code>Thread#raise</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber.html#method-i-raise"><code>Fiber#raise</code></a>
* **Code:**
  ```ruby
  f = Fiber.new do
    Fiber.yield 1
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/IO.html#method-c-select"><code>IO.select</code></a>
* **Code:**
* **Notes:**
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Socket.html#method-c-tcp"><code>Socket.tcp</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/TCPSocket.html#method-c-new"><code>TCPSocket.new</code></a>
* **Code:**
* **Notes:**
...
**Ports** are a new straigtforward mechanism for bidirectional exchange of data between ractors. Port can be passed between ractors on creation or `#send`/`#<<`. The ractor that has the reference to a port can write to it, and the ractor that created the port can read from it.
...
* **Discussion:** —
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-select"><code>Ractor.select</code></a>
* **Code:**
  ```ruby
  port = Ractor::Port.new
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-shareable_proc"><code>Ractor.shareable_proc</code></a>, <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Ractor.html#method-c-shareable_lambda"><code>Ractor.shareable_lambda</code></a>
* **Code:**
  ```ruby
  p = proc { puts "test" }
...
* **Reason:** The initial use case is to interrupt a fiber that is waiting on a blocking IO operation when the IO operation is closed.
* **Discussion:** <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/21166">Feature #21166</a>
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-fiber_interrupt"><code>Fiber::Scheduler#fiber_interrupt</code></a>
* **Code:**
  ```ruby
  scheduler.fiber_interrupt(fiber, exception)
  ```
* **Notes:**
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-yield"><code>Fiber::Scheduler#yield</code></a>
* **Code:**
* **Notes:**
...
* **Reason:**
* **Discussion:**
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-io_close"><code>Fiber::Scheduler#io_close</code></a>
* **Code:**
* **Notes:**
...
* **Documentation:** <a class="ruby-doc" href="https://docs.ruby-lang.org/en/master/Fiber/Scheduler.html#method-i-io_write"><code>Fiber::Scheduler#io_write</code></a>
* **Code:**
* **Notes:**
...
_Toretsk city ruined by Russian army in attempt to take it, by Konstantin and Vlada Liberov_
