...
* **Status (as of Dec 26, 2025):** 3.2.3 is security maintenance (will EOL soon!)
...
* **Follow-up:** `Set` was reimplemented as a "proper" core class [in Ruby 4.0](4.0.html#the-class-reimplemented-efficiently).
...
* <a class="github" href="https://github.com/ruby/uri">uri</a> 0.12.0
