...
In addition to [endless range in Ruby 2.6](TODO): `(start..)`, Ruby 2.7 introduces beginless one: `(..end)`.
...
> Note that Ruby 2.7 also [introduced a way](TODO) to turn off only some categories of warnings, for example, only deprecation ones.
...
* **Documentation:** [doc/syntax/modules_and_classes.rdoc#Visibility](https://docs.ruby-lang.org/en/master/syntax/modules_and_classes_rdoc.html#label-Visibility)
* **Code:**
  ```ruby
  class A
    def update
...
* **Documentation:** <a class="ruby-doc" href="https://ruby-doc.org/core-2.7.0.preview3/Module.html#method-i-const_source_location"><code>Module#const_source_location</code></a>
* **Code:**
  ```ruby
  # Assuming test.rb:
  class A
...
* **Documentation:** <a class="ruby-doc" href="https://ruby-doc.org/core-2.7.0.preview3/Time.html#method-i-floor"><code>Time#floor</code></a>, <a class="ruby-doc" href="https://ruby-doc.org/core-2.7.0.preview3/Time.html#method-i-ceil"><code>Time#ceil</code></a>
* **Code:**
  ```ruby
...
* **Documentation:** [WeekMap#[]=](https://ruby-doc.org/core-2.7.0.preview3/ObjectSpace/WeakMap.html#method-i-5B-5D-3D)
* **Code:**
  ```ruby
...
* **Documentation:** <a class="ruby-doc" href="https://ruby-doc.org/core-2.7.0.preview3/Range.html#method-i-minmax"><code>Range#minmax</code></a>
* **Code:**
  ```ruby
...
In 2.6 several exception class constructors [were enhanced](TODO) so the user code could create them providing context, now `FrozenError` also got this functionality.
...
`resolve_feature_path` was [introduced](TODO) in Ruby 2.6 as `RubyVM` method, now it is singleton method of `$LOAD_PATH` global variable.
...
* **Documentation:** _As it turns, documenting global's singleton method is not easy. So it is just mentioned at_ [doc/globals.rdoc](https://docs.ruby-lang.org/en/master/globals_rdoc.html)
* **Code:**
  ```ruby
  $LOAD_PATH.resolve_feature_path('net/http')
  # => [:rb, "/home/zverok/.rvm/rubies/ruby-head/lib/ruby/2.7.0/net/http.rb"]
  ```
* **Notes:** As method was just moved, for details of `resolve_feature_path` behavior, see [2.6 changelog's entry](TODO) (with the exception for what described in the next section)
...
* **Documentation:** [GC.compact](https://docs.ruby-lang.org/en/master/GC.html#method-c-compact)
...
* **Documentation:** [Warning::[]](https://docs.ruby-lang.org/en/master/Warning.html#method-c-5B-5D), [Warning::[]=](https://docs.ruby-lang.org/en/master/Warning.html#method-c-5B-5D-3D)
* **Code:**
  ```ruby
  {a: 1} in {a:}
...
* **Notes:**
  ...
  * Note that turning of `:deprecated` warning will also mute the warning of features which was deprecated explicitly in your code, for example with [Module#deprecate_constant](https://docs.ruby-lang.org/en/master/Module.html#method-i-deprecate_constant)
    ```ruby
    class HTTP
...
* `Date` supports [new Japanese era](https://en.wikipedia.org/wiki/Reiwa) in parsing and rendering dates (generic [Date.parse](https://docs.ruby-lang.org/en/master/Date.html#method-c-parse) and [.jisx0301](https://docs.ruby-lang.org/en/master/Date.html#method-c-jisx0301)/[#jisx0301](https://docs.ruby-lang.org/en/master/Date.html#method-i-jisx0301)). Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/15742">Feature #15742</a>
...
* <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/pathname/rdoc/Pathname.html#method-c-glob"><code>Pathname.glob</code></a> passes third argument, if provided, to `Dir.glob`, allowing to specify `base:` for globbing.
* <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/pathname/rdoc/Kernel.html#method-i-Pathname"><code>Pathname()</code></a> method doesn't duplicates argument, if it was already a `Pathname`
* <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/optparse/rdoc/OptionParser.html"><code>OptionParser</code></a> now uses "Did you mean?" feature. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/16256">Feature #16256</a>.
  ```ruby
  require 'optparse'
...
* <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/net/http/rdoc/Net/HTTP.html#method-c-start"><code>Net::HTTP#start</code></a>: new optional keyword parameter `ipaddr:`, and <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/net/http/rdoc/Net/HTTP.html#method-i-ipaddr"><code>#ipaddr=</code></a> setter allows to set the address for the connection manually. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/5180">Feature #5180</a>.
* `open-uri` library: 2 versions after more safe alias [was added](TODO), using `Kernel#open` finally became deprecated, and <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/open-uri/rdoc/URI.html#method-c-open"><code>URI.open</code></a> the main library's interface. Discussion: <a class="tracker misc" href="https://bugs.ruby-lang.org/issues/15893">Misc #15893</a>
  ```ruby
  require 'open-uri'
  ...
  # => ok
  ```
* <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/net/ftp/rdoc/Net/FTP.html#method-i-features"><code>Net::FTP#features</code></a> to check available features, and <a class="ruby-doc" href="https://ruby-doc.org/stdlib-2.7.0_rc1/libdoc/net/ftp/rdoc/Net/FTP.html#method-i-option"><code>Net::FTP#option</code></a> to enable/disable each of them. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/15964">Feature #15964</a>.
  ```ruby
  ftp = Net::FTP.new('speedtest.tele2.net') # TELE2's open FTP for speed tests
  ftp.features
  # => ["EPRT", "EPSV", "MDTM", "PASV", "REST STREAM", "SIZE", "TVFS"]
  ```
* `Net::IMAP` now supports [Server Name Indication (SNI)](https://en.wikipedia.org/wiki/Server_Name_Indication) support. Discussion: <a class="tracker feature" href="https://bugs.ruby-lang.org/issues/15594">Feature #15594</a>
