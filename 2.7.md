...
* **Status (as of Dec 23, 2020):** 2.7.1 is current _stable_
...
* **Follow-up:** Pattern matching became a stable (non-experimental) feature, and its power expanded signficantly [in 3.0](#pattern-matching).
...
* **Follow-up:** In Ruby 3.0, it was [allowed for user code]() to specify warning category, and intercept it.
