...
* **Follow-ups:**
  ...
  * [3.4](3.4.html#standalone-it-in-blocks-became-anonymous-argument): `it` was introduced.
...
* **Follow-up:** In [4.0](4.0.html#threadraisefiberraise-cause-keyword-argument), `Fiber#raise` signature was adjusted (to match the changed signature of `Kernel#raise` that allows to provide `cause:` of the exception).
