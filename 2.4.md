...
* **Status (as of Oct 13, 2019):** EOL soon, latest is 2.4.9
...
`frozen_object.clone(freeze: false)` now allows to receive unfrozen copy of a frozen object.
...
`TracePoint#callee_id` returns an actual name of the method being called, even if aliased.
