...
* **Code:**
  ...
  begin
    ...
    # "\e<a class="ruby-doc" href="https://ruby-doc.org/core-2.6/Dir.html#method-i-each_child">1mTraceback\e<a class="ruby-doc" href="https://ruby-doc.org/core-2.6/Dir.html#method-i-children"><code>m (most recent call last):\n\t1: from t.rb:2:in `<main>'\nt.rb:2:in `fetch': \e[1mkey not found: :b (\e[1;4mKeyError\e[m\e[1m)\e[m\n"
    p e.full_message
...
* **Documentation:** [Dir#each_child</a>, [Dir#children</code></a>
* **Code:**
  ```ruby
  Dir.new('.').children
